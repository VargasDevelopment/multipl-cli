...
from ..models.get_v1_jobs_job_id_response_200_job_moderation_status_type_0 import (
    GetV1JobsJobIdResponse200JobModerationStatusType0,
)
from ..models.get_v1_jobs_job_id_response_200_job_state import GetV1JobsJobIdResponse200JobState

if TYPE_CHECKING:
    from ..models.get_v1_jobs_job_id_response_200_job_acceptance import (
        GetV1JobsJobIdResponse200JobAcceptance,
    )
    from ..models.get_v1_jobs_job_id_response_200_job_input import GetV1JobsJobIdResponse200JobInput
    from ..models.get_v1_jobs_job_id_response_200_job_moderation_categories_type_0 import (
        GetV1JobsJobIdResponse200JobModerationCategoriesType0,
    )
    from ..models.get_v1_jobs_job_id_response_200_job_moderation_scores_type_0 import (
        GetV1JobsJobIdResponse200JobModerationScoresType0,
    )


T = TypeVar("T", bound="GetV1JobsJobIdResponse200Job")


@_attrs_define
class GetV1JobsJobIdResponse200Job:
    """
    Attributes:
        id (str):
        poster_id (str):
        task_type (str):
        input_ (GetV1JobsJobIdResponse200JobInput):
        acceptance (GetV1JobsJobIdResponse200JobAcceptance):
        requested_model (None | str):
        estimated_tokens (int | None):
        deadline_seconds (int | None):
        payout_cents (int | None):
        state (GetV1JobsJobIdResponse200JobState):
        created_at (str):
        updated_at (str):
        ...
        expires_at (str):
        moderation_status (GetV1JobsJobIdResponse200JobModerationStatusType0 | None):
        moderation_model (None | str):
        moderation_categories (GetV1JobsJobIdResponse200JobModerationCategoriesType0 | None):
        moderation_scores (GetV1JobsJobIdResponse200JobModerationScoresType0 | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.moderation_status, GetV1JobsJobIdResponse200JobModerationStatusType0):
        ...
        if isinstance(
            self.moderation_categories, GetV1JobsJobIdResponse200JobModerationCategoriesType0
        ):
        ...
        if isinstance(self.moderation_scores, GetV1JobsJobIdResponse200JobModerationScoresType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.get_v1_jobs_job_id_response_200_job_input import (
        ...
        input_ = GetV1JobsJobIdResponse200JobInput.from_dict(d.pop("input"))

        acceptance = GetV1JobsJobIdResponse200JobAcceptance.from_dict(d.pop("acceptance"))
        ...
        state = GetV1JobsJobIdResponse200JobState(d.pop("state"))
        ...
        def _parse_moderation_status(
            data: object,
        ) -> GetV1JobsJobIdResponse200JobModerationStatusType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                moderation_status_type_0 = GetV1JobsJobIdResponse200JobModerationStatusType0(data)

                return moderation_status_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetV1JobsJobIdResponse200JobModerationStatusType0 | None, data)
        ...
        def _parse_moderation_categories(
            data: object,
        ) -> GetV1JobsJobIdResponse200JobModerationCategoriesType0 | None:
            if data is None:
                return data
            try:
                ...
                moderation_categories_type_0 = (
                    GetV1JobsJobIdResponse200JobModerationCategoriesType0.from_dict(data)
                )

                return moderation_categories_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetV1JobsJobIdResponse200JobModerationCategoriesType0 | None, data)

        moderation_categories = _parse_moderation_categories(d.pop("moderationCategories"))

        def _parse_moderation_scores(
            data: object,
        ) -> GetV1JobsJobIdResponse200JobModerationScoresType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                ...
                moderation_scores_type_0 = (
                    GetV1JobsJobIdResponse200JobModerationScoresType0.from_dict(data)
                )

                return moderation_scores_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetV1JobsJobIdResponse200JobModerationScoresType0 | None, data)
        ...
        get_v1_jobs_job_id_response_200_job = cls(
            id=id,
            poster_id=poster_id,
            task_type=task_type,
            input_=input_,
        ...
        return get_v1_jobs_job_id_response_200_job
