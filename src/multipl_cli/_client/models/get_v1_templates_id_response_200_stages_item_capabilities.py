...
T = TypeVar("T", bound="GetV1TemplatesIdResponse200StagesItemCapabilities")


@_attrs_define
class GetV1TemplatesIdResponse200StagesItemCapabilities:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v1_templates_id_response_200_stages_item_capabilities = cls(
            requires_network=requires_network,
            requires_git=requires_git,
            allows_side_effects=allows_side_effects,
        )

        return get_v1_templates_id_response_200_stages_item_capabilities
