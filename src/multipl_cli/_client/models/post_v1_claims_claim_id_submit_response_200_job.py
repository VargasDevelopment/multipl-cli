...
from ..models.post_v1_claims_claim_id_submit_response_200_job_moderation_status_type_0 import (
    PostV1ClaimsClaimIdSubmitResponse200JobModerationStatusType0,
)
from ..models.post_v1_claims_claim_id_submit_response_200_job_state import (
    PostV1ClaimsClaimIdSubmitResponse200JobState,
)

if TYPE_CHECKING:
    from ..models.post_v1_claims_claim_id_submit_response_200_job_acceptance import (
        PostV1ClaimsClaimIdSubmitResponse200JobAcceptance,
    )
    from ..models.post_v1_claims_claim_id_submit_response_200_job_input import (
        PostV1ClaimsClaimIdSubmitResponse200JobInput,
    )
    from ..models.post_v1_claims_claim_id_submit_response_200_job_moderation_categories_type_0 import (
        PostV1ClaimsClaimIdSubmitResponse200JobModerationCategoriesType0,
    )
    from ..models.post_v1_claims_claim_id_submit_response_200_job_moderation_scores_type_0 import (
        PostV1ClaimsClaimIdSubmitResponse200JobModerationScoresType0,
    )


T = TypeVar("T", bound="PostV1ClaimsClaimIdSubmitResponse200Job")


@_attrs_define
class PostV1ClaimsClaimIdSubmitResponse200Job:
    """
    Attributes:
        id (str):
        poster_id (str):
        task_type (str):
        input_ (PostV1ClaimsClaimIdSubmitResponse200JobInput):
        acceptance (PostV1ClaimsClaimIdSubmitResponse200JobAcceptance):
        requested_model (None | str):
        estimated_tokens (int | None):
        deadline_seconds (int | None):
        payout_cents (int | None):
        state (PostV1ClaimsClaimIdSubmitResponse200JobState):
        created_at (str):
        updated_at (str):
        ...
        expires_at (str):
        moderation_status (None | PostV1ClaimsClaimIdSubmitResponse200JobModerationStatusType0):
        moderation_model (None | str):
        moderation_categories (None | PostV1ClaimsClaimIdSubmitResponse200JobModerationCategoriesType0):
        moderation_scores (None | PostV1ClaimsClaimIdSubmitResponse200JobModerationScoresType0):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.moderation_status, PostV1ClaimsClaimIdSubmitResponse200JobModerationStatusType0
        ):
        ...
        if isinstance(
            self.moderation_scores, PostV1ClaimsClaimIdSubmitResponse200JobModerationScoresType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        input_ = PostV1ClaimsClaimIdSubmitResponse200JobInput.from_dict(d.pop("input"))

        acceptance = PostV1ClaimsClaimIdSubmitResponse200JobAcceptance.from_dict(
            d.pop("acceptance")
        )
        ...
        state = PostV1ClaimsClaimIdSubmitResponse200JobState(d.pop("state"))
        ...
        def _parse_moderation_status(
            data: object,
        ) -> None | PostV1ClaimsClaimIdSubmitResponse200JobModerationStatusType0:
            if data is None:
                return data
            try:
                ...
                moderation_status_type_0 = (
                    PostV1ClaimsClaimIdSubmitResponse200JobModerationStatusType0(data)
                )

                return moderation_status_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostV1ClaimsClaimIdSubmitResponse200JobModerationStatusType0, data)
        ...
        def _parse_moderation_categories(
            data: object,
        ) -> None | PostV1ClaimsClaimIdSubmitResponse200JobModerationCategoriesType0:
            if data is None:
                return data
            try:
                ...
                moderation_categories_type_0 = (
                    PostV1ClaimsClaimIdSubmitResponse200JobModerationCategoriesType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PostV1ClaimsClaimIdSubmitResponse200JobModerationCategoriesType0, data
            )
        ...
        def _parse_moderation_scores(
            data: object,
        ) -> None | PostV1ClaimsClaimIdSubmitResponse200JobModerationScoresType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                ...
                moderation_scores_type_0 = (
                    PostV1ClaimsClaimIdSubmitResponse200JobModerationScoresType0.from_dict(data)
                )

                return moderation_scores_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostV1ClaimsClaimIdSubmitResponse200JobModerationScoresType0, data)
        ...
        post_v1_claims_claim_id_submit_response_200_job = cls(
            id=id,
            poster_id=poster_id,
            task_type=task_type,
            input_=input_,
        ...
        return post_v1_claims_claim_id_submit_response_200_job
