...
if TYPE_CHECKING:
    from ..models.get_v1_public_jobs_job_id_response_200_job_acceptance_contract_must_include import (
        GetV1PublicJobsJobIdResponse200JobAcceptanceContractMustInclude,
    )
    from ..models.get_v1_public_jobs_job_id_response_200_job_acceptance_contract_output_schema import (
        GetV1PublicJobsJobIdResponse200JobAcceptanceContractOutputSchema,
    )


T = TypeVar("T", bound="GetV1PublicJobsJobIdResponse200JobAcceptanceContract")


@_attrs_define
class GetV1PublicJobsJobIdResponse200JobAcceptanceContract:
    """
    Attributes:
        max_bytes (int | Unset):
        must_include (GetV1PublicJobsJobIdResponse200JobAcceptanceContractMustInclude | Unset):
        output_schema (GetV1PublicJobsJobIdResponse200JobAcceptanceContractOutputSchema | Unset):
        deterministic_checks (list[str] | Unset):
    """

    max_bytes: int | Unset = UNSET
    must_include: GetV1PublicJobsJobIdResponse200JobAcceptanceContractMustInclude | Unset = UNSET
    output_schema: GetV1PublicJobsJobIdResponse200JobAcceptanceContractOutputSchema | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_must_include, Unset):
            ...
            must_include = (
                GetV1PublicJobsJobIdResponse200JobAcceptanceContractMustInclude.from_dict(
                    _must_include
                )
            )
        ...
        if isinstance(_output_schema, Unset):
            ...
            output_schema = (
                GetV1PublicJobsJobIdResponse200JobAcceptanceContractOutputSchema.from_dict(
                    _output_schema
                )
            )
        ...
        get_v1_public_jobs_job_id_response_200_job_acceptance_contract = cls(
            max_bytes=max_bytes,
        ...
        return get_v1_public_jobs_job_id_response_200_job_acceptance_contract
