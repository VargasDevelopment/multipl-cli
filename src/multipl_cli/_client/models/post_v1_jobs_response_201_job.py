...
from ..models.post_v1_jobs_response_201_job_moderation_status_type_0 import (
    PostV1JobsResponse201JobModerationStatusType0,
)
from ..models.post_v1_jobs_response_201_job_state import PostV1JobsResponse201JobState

if TYPE_CHECKING:
    from ..models.post_v1_jobs_response_201_job_acceptance import PostV1JobsResponse201JobAcceptance
    from ..models.post_v1_jobs_response_201_job_input import PostV1JobsResponse201JobInput
    from ..models.post_v1_jobs_response_201_job_moderation_categories_type_0 import (
        PostV1JobsResponse201JobModerationCategoriesType0,
    )
    from ..models.post_v1_jobs_response_201_job_moderation_scores_type_0 import (
        PostV1JobsResponse201JobModerationScoresType0,
    )


T = TypeVar("T", bound="PostV1JobsResponse201Job")


@_attrs_define
class PostV1JobsResponse201Job:
    """
    Attributes:
        id (str):
        poster_id (str):
        task_type (str):
        input_ (PostV1JobsResponse201JobInput):
        acceptance (PostV1JobsResponse201JobAcceptance):
        requested_model (None | str):
        estimated_tokens (int | None):
        deadline_seconds (int | None):
        payout_cents (int | None):
        state (PostV1JobsResponse201JobState):
        created_at (str):
        updated_at (str):
        ...
        expires_at (str):
        moderation_status (None | PostV1JobsResponse201JobModerationStatusType0):
        moderation_model (None | str):
        moderation_categories (None | PostV1JobsResponse201JobModerationCategoriesType0):
        moderation_scores (None | PostV1JobsResponse201JobModerationScoresType0):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.moderation_status, PostV1JobsResponse201JobModerationStatusType0):
        ...
        if isinstance(
            self.moderation_categories, PostV1JobsResponse201JobModerationCategoriesType0
        ):
        ...
        if isinstance(self.moderation_scores, PostV1JobsResponse201JobModerationScoresType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.post_v1_jobs_response_201_job_acceptance import (
        ...
        input_ = PostV1JobsResponse201JobInput.from_dict(d.pop("input"))

        acceptance = PostV1JobsResponse201JobAcceptance.from_dict(d.pop("acceptance"))
        ...
        state = PostV1JobsResponse201JobState(d.pop("state"))
        ...
        def _parse_moderation_status(
            data: object,
        ) -> None | PostV1JobsResponse201JobModerationStatusType0:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                moderation_status_type_0 = PostV1JobsResponse201JobModerationStatusType0(data)

                return moderation_status_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostV1JobsResponse201JobModerationStatusType0, data)
        ...
        def _parse_moderation_categories(
            data: object,
        ) -> None | PostV1JobsResponse201JobModerationCategoriesType0:
            if data is None:
                return data
            try:
                ...
                moderation_categories_type_0 = (
                    PostV1JobsResponse201JobModerationCategoriesType0.from_dict(data)
                )

                return moderation_categories_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostV1JobsResponse201JobModerationCategoriesType0, data)

        moderation_categories = _parse_moderation_categories(d.pop("moderationCategories"))

        def _parse_moderation_scores(
            data: object,
        ) -> None | PostV1JobsResponse201JobModerationScoresType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                moderation_scores_type_0 = PostV1JobsResponse201JobModerationScoresType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | PostV1JobsResponse201JobModerationScoresType0, data)
        ...
        post_v1_jobs_response_201_job = cls(
            id=id,
            poster_id=poster_id,
            task_type=task_type,
            input_=input_,
        ...
        return post_v1_jobs_response_201_job
