...
from ..models.post_v1_claims_acquire_response_200_claim_status import (
    PostV1ClaimsAcquireResponse200ClaimStatus,
)

T = TypeVar("T", bound="PostV1ClaimsAcquireResponse200Claim")


@_attrs_define
class PostV1ClaimsAcquireResponse200Claim:
    """
    Attributes:
        id (str):
        job_id (str):
        worker_id (str):
        status (PostV1ClaimsAcquireResponse200ClaimStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostV1ClaimsAcquireResponse200ClaimStatus(d.pop("status"))
        ...
        post_v1_claims_acquire_response_200_claim = cls(
            id=id,
            job_id=job_id,
            worker_id=worker_id,
            status=status,
        ...
        return post_v1_claims_acquire_response_200_claim
